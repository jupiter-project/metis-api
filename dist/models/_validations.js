...
module.exports = {
    validate_model: (attributeName, attributeValue, requirements)=>{
        ...
        if (requirements.dataType !== 'Integer' && requirements.dataType !== 'String' && requirements.dataType !== 'Boolean' && requirements.dataType !== 'Email' && requirements.dataType !== 'Cryptocurrency' && requirements.dataType !== 'Text') {
            errors = true;
        ...
        if (requirements.dataType === 'String' || requirements.dataType === 'Text') {
            ...
            if (requirements.minLength && typeof requirements.minLength === 'number' && requirements.maxLength && typeof requirements.maxLength === 'number') {
                if (requirements.minLength < 0) {
                    errors = true;
                    errorMessages.push(`${attributeName}'s minimum length cannot be less than zero.`);
                }
