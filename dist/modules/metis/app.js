/* eslint-disable n/no-path-concat */ "use strict";
...
module.exports = (app, jobs, websocket)=>{
    ...
    if (fs.existsSync(constantsPath)) {
        const constantsTree = dirTree(constantsPath, {
            extensions: /\.js$/
        });
