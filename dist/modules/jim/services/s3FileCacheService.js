...
const _jimConfig = require("../config/jimConfig");
...
module.exports.s3FileCacheService = new S3FileCacheService(_jimConfig.jimConfig.fileCacheLocation, CacheWindowInDays);
