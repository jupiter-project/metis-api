 ...
 */ module.exports.instantiateMinimumGravityAccountProperties = (passphrase, password, address)=>{
    ...
    return new GravityAccountProperties(address, null, null, passphrase, gu.generateHash(password), password, encryptAlgorithm);
};
/**
 ...
 */ module.exports.instantiateGravityAccountProperties = async (passphrase, password)=>{
    ...
    return jupiterAccountService.fetchAccountInfo(passphrase).then((accountInfo)=>{
        ...
        const properties = new GravityAccountProperties(accountInfo.address, accountInfo.accountId, accountInfo.publicKey, passphrase, gu.generateHash(password), password, encryptAlgorithm);
