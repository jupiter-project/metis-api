...
const { ApplicationAccountProperties , metisApplicationAccountProperties  } = require('../gravity/applicationAccountProperties');
...
class JupiterAPIService {
   ...
   */ _jupiterRequest(rtype, params, data = {}) {
     ...
     */ async jupiterRequest(rtype, params, data = {}) {
        ...
        try {
            ...
            if (Object.prototype.hasOwnProperty.call(response, 'data') && Object.prototype.hasOwnProperty.call(response.data, 'errorDescription') && response.data.errorDescription) {
   ...
   */ async getBlockChainTransactions(address, message = null, withMessage = false, type = 1, includeExpiredPrunable = true, firstIndex = null, lastIndex = null) {
        ...
        const transactionsResponse = await this._getConfirmedOrUnconfirmedBlockChainTransactions(requestType, address, message, withMessage, type, includeExpiredPrunable, firstIndex, lastIndex);
     ...
     *           >}
     */ async getUnconfirmedBlockChainTransactions(address, message = null, withMessage = false, type = 1, includeExpiredPrunable = true, firstIndex = null, lastIndex = null) {
        ...
        const transactionsResponse = await this._getConfirmedOrUnconfirmedBlockChainTransactions(JupiterAPIService.RequestType.GetUnconfirmedTransactions, address, message, withMessage, type, includeExpiredPrunable, firstIndex, lastIndex);
   ...
   *                                   }>}
   */ async _getConfirmedOrUnconfirmedBlockChainTransactions(requestType, address, message = null, withMessage = false, type = 1, includeExpiredPrunable = true, firstIndex = null, lastIndex = null) {
   ...
   */ async sendSimpleNonEncipheredMessageOrMetisMessage(requestType, from, to, message, fee, subtype, prunable) {
        ...
        return this.sendMetisMessageOrMessage(requestType, to.address, to.publicKey, from.passphrase, from.publicKey, fee, this.appProps.deadline, null, null, message, true, prunable, null, null, null, null, null, null, null, null, null, null, null, subtype);
    }
    /**
   * sends an enciphered, non-prunable , compressed message*
   * @param {GravityAccountProperties} from
   ...
   */ async sendSimpleEncipheredMessageOrMetisMessage(requestType, from, to, message, fee, subtype, prunable) {
        ...
        return this.sendMetisMessageOrMessage(requestType, to.address, to.publicKey, from.passphrase, from.publicKey, fee, this.appProps.deadline, null, null, null, null, null, message, true, null, null, prunable, true, null, null, null, null, null, subtype);
    }
    /**
   ...
   */ sendEncipheredMetisMessageAndMessage(from, to, messageToEncrypt, message, fee, subtype, prunable, recipientPublicKey) {
        ...
        return this.sendMetisMessageOrMessage('sendMetisMessage', to, recipientPublicKey, from, null, fee, this.appProps.deadline, null, null, message, null, null, messageToEncrypt, true, null, null, prunable, true, null, null, null, null, null, subtype);
    }
    /**
   *
   ...
   */ async transferMoney(fromAccountProperties, toAccountProperties, amountNqt, feeNqt = this.appProps.feeNQT) {
        ...
        return this.post({
            ...
            secretPhrase: fromAccountProperties.passphrase,
            amountNQT: amountNqt,
            feeNQT: feeNqt,
   ...
   */ setAlias(address, passphrase, alias) {
    ...
    getState() {
        ...
        const params = {
            requestType: JupiterAPIService.RequestType.GetState
        };
        return this.get(params);
    }
    /**
