...
const _curve25519Js = require("curve25519-js");
...
class JupiterCrypto {
   ...
   */ getSharedSecret(myPrivateKey, theirPublicKey) {
        ...
        const sharedSecret = (0, _curve25519Js.sharedKey)(myPrivateKey, theirPublicKey);
   ...
   * @param nonce
   * @returns {string}
   */ getSharedKey(myPrivateKey, theirPublicKey, nonce1) {
