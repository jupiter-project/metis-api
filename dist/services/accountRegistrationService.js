 ...
 */ class AccountRegistration {
   ...
   * @param tableService
   * @param gravity
   */ constructor(applicationGravityAccountProperties, jupApi, jupiterTransactionsService, jupiterFundingService, jupiterAccountService, tableService, gravity){
   ...
   */ attachMissingDefaultTables(currentlyAttachedTableStatements, tableOwnerProperties) {
        ...
        return Promise.all(tablesToAttach).then((tablesToAttachResults)=>{
            ...
            return this.tableService.createTableListRecord(tableOwnerProperties, this.defaultTableNames()).then((createTableListRecordResponse)=>{
                ...
                const transactionsReport = tablesToAttachResults.reduce((reduced, tablesToAttachResult)=>{
                    reduced = [
                        ...reduced,
                        ...tablesToAttachResult.transactions
                    ];
                    return reduced;
                }, []);
   ...
   */ async attachTable(tableName, accountProperties) {
        ...
        return new Promise((resolve, reject)=>{
            ...
            this.gravity.attachTable(accessData, tableName).then((response)=>{
...
module.exports.accountRegistration = new AccountRegistration(metisGravityAccountProperties, jupiterAPIService, jupiterTransactionsService, jupiterFundingService, jupiterAccountService, tableService, gravity);
