const { instantiateMinimumGravityAccountProperties } = require('../gravity/instantiateGravityAccountProperties')
    ...
    try {
      ...
      if (!channelAccountProperties) {
        return res
          ...
          .send({ message: `The channel is not available: ${channelAddress}` })
      }
