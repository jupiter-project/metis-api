  ...
  unconfirmedTransactions: [
    {
      ...
      signature:
        'a24833bbb2a5a62b5c82cd2e323873d3bda5249d40e554c6dd14bf320b835f09e0bfc86ff02b76e627c63d0d803d4e14c824d905b2d2905f66692e81484cadb8',
      feeNQT: '500',
      type: 1,
    ...
    describe('createNewAddress', () => {
      it('should should return address and public key from axios response', async () => {
        axios.get.mockResolvedValueOnce({
          data: { success: true, accountRS: 'THIS_IS_AN_ADDRESS', publicKey: '123456' }
        })
    ...
    describe('Development Functions', () => {
      describe('createTable', () => {
        ...
        it('should return two console messages and close interactive screen if balance is insufficient', async () => {
          ...
          expect(consoleCalls[1]).toBe(
            `A minimum of ${parseFloat(
              gravity.jupiter_data.minimumAppBalance / 10 ** gravity.jupiter_data.moneyDecimals
