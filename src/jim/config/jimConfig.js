...
if (!(fileCacheStrategy === 'local' || fileCacheStrategy === 's3'))
  throw new Error(`Environment Variable is invalid: FILE_CACHE_STRATEGY= ${fileCacheStrategy}`)
let fileCacheConfig = {
...
if (!process.env.JIMSRV_BINARY_ACCOUNT_MIN_BALANCE)
  throw new Error(`Environment Variable missing: JIMSRV_BINARY_ACCOUNT_MIN_BALANCE `)
