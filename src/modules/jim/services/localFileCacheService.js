...
if (jimConfig.fileCache.strategy !== 'local') {
  throw new mError.MetisError(`This fileCache Strategy not implemented yet: ${jimConfig.fileCache.strategy}`)
}
module.exports.localFileCacheService = new LocalFileCacheService(jimConfig.fileCache.location, CacheWindowInDays)
