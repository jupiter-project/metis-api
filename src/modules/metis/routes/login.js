...
module.exports = (app, jobs, websocket) => {
  ...
  app.post('/v2/api/login', async (req, res, next) => {
    ...
    try {
      ...
      const userAccountProperties = await jupiterAccountService.getMemberAccountPropertiesFromPersistedUserRecordOrNull(
        passphrase,
        password
      )
      ...
      return res
        ...
        .send({ message: 'Theres a problem with login', code: MetisErrorCode.MetisErrorFailedUserAuthentication })
    }
  })
